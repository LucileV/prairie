<?php include 'include/header-bootstrap.php' ?>
    ...
    <div class="container-fluid">
	    <div class="site-wrapper">
		    <div class="site-wrapper-inner">
			 ...
			 ?>
				...
				<blockquote class="lead text-muted alert-info jumbotron">Infographiste Web depuis plusieurs années en entreprise ainsi qu’entant qu’indépendante, j’ai décidé de suivre en 2007 une formation de 12 mois de concepteur réalisateur de produits en ligne à l’école des Gobelins à Paris. 10 ans plus tard, c’est vers le développement web que j’ai souhaité m’orienter afin d’évoluer dans les métiers du web toujours en évolution. Pour cela, depuis 2016, je prends le temps de me former auprès de différents <a href="#formation" class="js-scrollTo"><i>centres</i></a>.</blockquote>
				<p >
				  <a href="http://lucileverrecchia.com" class="btn btn-lg btn-secondary btn-default align-center" target="_blank"><i class="fa fa-external-link" aria-hidden="true"></i>Visit my Website</a>
				</p>
			   </div>
	   ...
	   <div class="row" id="langue">
		  <div class="col-md-3"><span class="flag-icon flag-icon-fr flag-icon-squared"></span> Langue maternelle</div>
		  <div class="col-md-3"><span class="flag-icon flag-icon-gb flag-icon-squared"></span> B2, Formation de 5 mois</div>
		  <div class="col-md-3"><span class="flag-icon flag-icon-it flag-icon-squared"></span> B1, 1 an à Florence</div>
		  <div class="col-md-3"><span class="flag-icon flag-icon-es flag-icon-squared"></span> A2, 3 mois à Barcelone</div>
	   ...
	   <section id="experience">
			 ...
			 <table class="table table-striped">
				...
				<tbody class="tablemore">
				  <tr >
				    ...
				    <td><b>Web Designer</b><br> Réalisations de sites web pour différentes  sociétés françaises et canadiennes. <br>
				  ...
				  <tr>
				    ...
				    <td><b>Pigiste</b><br> Rédaction d’articles de presse pour un Webzine féminin.</td>
				  </tr>
				  <tr>
				    <td>2004 > 06</td>
				    <td class="bold">Addvismédia - Paris</td>
				    <td><b>Web Designer</b><br> Agence de e-marking. <br>Publicité en ligne. Banners, mini sites. Actuellement <a href="http://www.nextedia.com/" target="_blank">Nextedia</a>.</td>
				  </tr>
				   <tr>
				    <td>2003 > 04</td>
				    <td>Labotec - Paris</td>
				    <td><b>Web Designer</b><br>Web Agency.  Création de maquettes graphiques de sites internet ou wap clients.</td>
				  </tr>
				   <tr>
				    <td>2008 > 13</td>
				    <td><a href="http://www.rhrexpert.com" target:"_blank">RHR Expert</a> - Montréal</td>
				    <td><b>Web Master</b> <br>Conception et réalisation du site rhrexpert.com. Flash , CSS2 et Html. <br>RHR Expert à Montréal, me faisait confiance pour la gestion <br> de l’ensemble de ses sites internet du Réseau Génie Carrières de Montréal.</td>
				  </tr>
				</tbody>
			   </table>
			</div>
		  ...
		  <section id="formation" class="scroll">
			 <div class="row">
				...
				<div class="col-md-6" align="center">
				    <h1>Becode</h1>Septembre 2017 à avril 2018 <div id="imgformation"><a href="http://www.becode.org/" target="_blank"><img src="images/becode.png" alt="cepegra" class="img-responsive img-thumbnail"></a>Besoin d'un stagiaire 2 mois en avril 2018?
				    </div>
				    
				</div>
				<div class="col-md-6" align="center">
				    <h1>Cepegra</h1>Mai à Juillet 2016 
				    <div id="imgformation"><a href="https://formation-cepegra.be/" target="_blank"><img src="images/cepegra.jpg" alt="cepegra" class="img-responsive img-thumbnail"></a>
		  ...
		  <h2>Loisirs</h2>
		  <ul>
			 <li><b>Culture :</b> Musées d’art contemporain, expostions de
			 photographies, théatre d’improvisation, festivals et concerts.</li>
			 <li><b>Loisirs :</b> Voyages et langues, montagne et sports de
			 glisse. Badminton, tennis et natation.</li>
			 <li><b>Hobby du quotidien :</b> Ma fille de 3 ans.</li>
		  </ul>
